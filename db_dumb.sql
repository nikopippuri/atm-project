...
CREATE TABLE `account` (
  ...
  CONSTRAINT `idcustomer` FOREIGN KEY (`idaccount`) REFERENCES `customer` (`idcustomer`)
...
CREATE TABLE `transaction` (
  ...
  CONSTRAINT `idaccount` FOREIGN KEY (`idtransaction`) REFERENCES `account` (`idaccount`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-01-09 19:30:58
